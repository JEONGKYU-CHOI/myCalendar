...
<body>
  ...
  <div class="input-group-prepend">
    <span class="input-group-text" id="inputGroup-sizing-default" style="background-color: lightgray; font-style: normal; font-size: medium;">게시글 제목</span>
  </div>
  <input type="text" name="boardTitle" class="form-control" aria-label="Sizing example input" aria-describedby="제목" value="${board.boardTitle}" readonly="readonly" style="font-size: medium;">
    <span class="input-group-text" id="inputGroup-sizing-default" style="background-color: lightgray; font-style: normal; font-size: medium;">NAME</span>
  <input type="text" name="boardName" class="form-control" aria-label="Sizing example input" aria-describedby="작성자" value="${board.boardName}" readonly="readonly" style="font-size: medium;"> 
</div>
</div>
  <input type="hidden" name="id" class="form-control" aria-label="Sizing example input" value="${board.id}" readonly="readonly">

    
  <textarea class="text" id="summernote" name="boardContent" style="font-size: large;">${board.boardContent}</textarea>
