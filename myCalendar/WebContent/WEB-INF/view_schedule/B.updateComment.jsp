...
<body>
  	...
  	댓글 작성자 : <input id="name" type="text" name="commentName" style="width: 30%;" value="${comment.commentName}" readonly="readonly"> <br>
 	댓글 제목 : <input id="title" type="text" name="commentTitle" style="width: 50%;" value="${comment.commentTitle}" readonly="readonly"> <br> 
